// from https://github.com/OpenZeppelin/cairo-contracts/blob/cairo-1/src/openzeppelin/token/erc20.cairo
...
mod ERC20 {
    ...
    fn mint(recipient: ContractAddress, amount: u256) {
        assert(get_caller_address() == _owner::read(), 'only owner can mint');
